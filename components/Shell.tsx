  ...
  return <footer className="kx-footer">
    ...
    <div className="kx-container">
      ...
      <div className="footer-grid">
        <div className="footer-brand"><Link href="/" className="kx-footer-logo"><Image src="/kaarnex/logo.png" alt="Kaarnex" width={430} height={115}/></Link></div>
